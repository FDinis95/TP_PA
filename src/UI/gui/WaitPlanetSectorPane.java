...
public class WaitPlanetSectorPane extends BorderPane {
    ...
    //SPACESTATION INFO STUFF
    private HBox buttonPane = new HBox();
    private Button entrarPlaneta = new Button("Entrar no Planeta");
    ...
    //MAPA STUFF
    private ImageView spaceShip = new ImageView();
    private Circle planeta = new Circle();
    ...
    private void organizaUsaRecursos(){
        ...
        referenceCard.setFitWidth(400);
        referenceCard.setFitHeight(400);
...
//        planetBox.setAlignment(Pos.CENTER);
    ...
    private void organizaMapa(){
        ...
        //Pode estar a dar erro aqui!
        if(modeloObs.getJogo().getSpaceShip() instanceof MilitaryShip){
            spaceShip.setImage(Imagens.getImagem(MILITARY_SHIP));
            ...
            spaceShip.setImage(Imagens.getImagem(MINING_SHIP));
            spaceShip.setFitHeight(50);
            spaceShip.setFitWidth(50);
            spaceShip.setTranslateX(-25);
            spaceShip.setTranslateY(-30);
